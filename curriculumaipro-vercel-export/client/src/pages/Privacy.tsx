        ...
        <div className="prose prose-neutral max-w-none text-foreground space-y-6">
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              name and email address when you create an account or subscribe to
              our newsletter. We also collect usage data including curricula you
              generate, pages you visit, and features you use.
            </p>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-2">
            ...
            <p className="text-muted-foreground">
              ...
              improve our services, process transactions, send transactional and
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              operating our platform, including payment processors (Stripe) and
              analytics providers.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              support@curriculumaipro.com to exercise these rights.
            </p>
          </section>
          <section>
